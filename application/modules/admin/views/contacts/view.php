...
?>
    ...
    <div class="container-fluid mt--6">
      <div class="row">
        ...
        <!-- REPLY YANG BELUM BISA DIGUNAKAN-->
        <div class="col-md-7">
            <div class="card card-primary">
                ...
                <div class="card-footer">
                    <input type="submit" value="Kirim Balasan" class="btn btn-primary" disabled>
                </div>
                </form>
            </div>
  ...
  <div class="modal-dialog modal-modal-dialog-centered modal-" role="document">
      <div class="modal-content">
          ...
          <form action="#" id="deleteContact" method="POST">
            ...
            <input type="hidden" name="id" value="<?php echo $contact->id; ?>" class="deleteID">
