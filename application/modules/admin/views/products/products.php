                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <br>
                                    <br>
                                    Rp <?php echo format_rupiah($product->price); ?> <br> Stok: <?php echo ($product->stock > 0) ? $product->stock .' '. $product->product_unit: '<span class="text-danger"><em>Stok habis</em></span>'; ?> <br> 
                                </div>
