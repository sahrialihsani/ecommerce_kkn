              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <div class="input-group mb-3">
                        ...
                        <input type="number" name="price" value="<?php echo set_value('price', $product->price); ?>" class="form-control" id="price" min='0'>
                      </div>
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="number" name="price_discount" value="<?php echo set_value('price_discount', $product->current_discount); ?>" class="form-control" id="price_d"  min='0'>
                  </div>
                ...
                <div class="row">
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <input type="number" name="stock" value="<?php echo set_value('stock', $product->stock); ?>" class="form-control" id="stock"  min='0'>
