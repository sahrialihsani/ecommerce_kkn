        ...
        <div class="col-xl-3 col-md-6">
          <div class="card bg-gradient-primary border-0">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0 text-white">PRODUK</h5>
                ...
                <div class="col-auto">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" style="">
                    <a class="dropdown-item" href="<?php echo site_url('admin/products'); ?>">Lihat detail</a>
                  </div>
                </div>
              </div>
              <p class="mt-3 mb-0 text-sm">
                <span class="text-nowrap text-white font-weight-600">Jumlah produk</span>
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  ...
                  <span class="h2 font-weight-bold mb-0 text-white"><?php echo $total_customers; ?></span>
                </div>
                <div class="col-auto">
                  <button type="button" class="btn btn-sm btn-neutral mr-0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fas fa-ellipsis-h"></i>
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="<?php echo site_url('admin/customers'); ?>">Lihat detail</a>
                  </div>
                </div>
              </div>
              <p class="mt-3 mb-0 text-sm">
                <span class="text-nowrap text-white font-weight-600">Pelanggan yang terdaftar</span>
              </p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-md-6">
          <div class="card bg-gradient-danger border-0">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  <h5 class="card-title text-uppercase text-muted mb-0 text-white">PESANAN</h5>
                  <span class="h2 font-weight-bold mb-0 text-white"><?php echo $total_order; ?></span>
                </div>
                <div class="col-auto">
                  <button type="button" class="btn btn-sm btn-neutral mr-0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fas fa-ellipsis-h"></i>
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="<?php echo site_url('admin/orders'); ?>">Lihat detail</a>
                  </div>
                </div>
              </div>
              <p class="mt-3 mb-0 text-sm">
                <span class="text-nowrap text-white font-weight-600">Jumlah pesanan diterima </span>
              </p>
            </div>
          </div>
        </div>
            ...
            <div class="card-body">
              <div class="row">
                <div class="col">
                  ...
                  <span class="h2 font-weight-bold mb-0 text-white">Rp <?php echo format_rupiah($total_income); ?></span>
                </div>
                <div class="col-auto">
                  <button type="button" class="btn btn-sm btn-neutral mr-0" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fas fa-ellipsis-h"></i>
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="<?php echo site_url('admin/payments'); ?>">Lihat detail</a>
                  </div>
                </div>
              </div>
              <p class="mt-3 mb-0 text-sm">
                <span class="text-nowrap text-white font-weight-600">Total pendapatan </span>
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div class="row align-items-center">
                    <div class="col-auto">
                      ...
                      <a href="#" class="avatar rounded-circle">
                        ...
                        <?php 
                          $picture = $customer->profile_picture;
                          $file = './assets/uploads/users/'. $picture;
                  
                              $picture_name = $picture;

                  
                          echo base_url('assets/uploads/users/'. $picture_name);
                        ?>">
                      </a>
                    </div>
                    <div class="col ml--2">
