...
class Order_model extends CI_Model {
    ...
    {
        $orders = $this->db->query("
            SELECT CONCAT(payment_method, order_status) AS `status`, o.id, o.order_number, o.order_date, o.order_status, o.payment_method, o.total_price, o.total_items, c.name AS coupon, cu.name AS customer
            FROM orders o
            LEFT JOIN coupons c
                ON c.id = o.coupon_id
            JOIN customers cu
