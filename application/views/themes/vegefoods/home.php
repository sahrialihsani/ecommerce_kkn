...
<section id="home-section" class="hero">
  <div class="home-slider owl-carousel">
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/image_3.jpg'); ?>);">
      <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Menyediakan Sayuran<br>segar dan tanpa pestisida </h1>
            <h2 class="subheading mb-4">Anda puas kami pun senang!</h2>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/minuman.jpg'); ?>);">
      <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2">Menyediakan minuman herbal
</h1>
            <h2 class="subheading mb-4">Minuman menyehatkan dan tanpa bahan pengawet</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/rice_box.jpg'); ?>);">
      <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Menyediakan Olahan Makanan<br>Lezat dan tanpa bahan pengawet </h1>
            <h2 class="subheading mb-4">Anda puas kami pun senang!</h2>
            <p><a href="#products" class="btn btn-primary">Belanja Sekarang</a></p>
          </div>
