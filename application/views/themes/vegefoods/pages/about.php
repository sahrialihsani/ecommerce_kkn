...
<section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
  <div class="container">
    <div class="row">
      <div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_uri('images/yumbox.jpeg'); ?>);">
        <a href="<?=base_url('video/video.mp4')?>" class="icon popup-vimeo d-flex justify-content-center align-items-center">
