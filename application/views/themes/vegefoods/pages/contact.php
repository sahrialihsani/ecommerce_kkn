...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/about_us.jpg'); ?>');">
  <div class="container">
      ...
      <div class="col-md-6 order-md-last d-flex">
        <form action="<?php echo site_url('pages/send_message'); ?>" class="bg-white p-5 contact-form" method="POST">
          ...
          <div class="form-group">
            <input type="text" name="name" class="form-control" value="<?php echo set_value('name', (is_login() && is_customer()? get_user_name() : '')); ?>" placeholder="Nama" required>
            <?php echo form_error('name'); ?>
          </div>
          <div class="form-group">
            <input type="email" name="email" class="form-control" value="<?php echo set_value('email', (is_login() && is_customer() ? $user->email : '')); ?>" placeholder="Email" required>
      ...
      <div class="col-md-6 d-flex">
        <div style="width: 100%">
          <!-- <iframe width="100%" height="600" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2367.1502352502644!2d102.26661758185583!3d-3.7978940887020043!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e36b022aa6ac639%3A0xd756391dfb17f5bb!2sSimpang%20Lima%20Ratu%20Samban!5e0!3m2!1sid!2sid!4v1620229621040!5m2!1sid!2sid" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" loading="lazy">
           -->
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63699.70239991922!2d102.28002416955658!3d-3.7597391017843207!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e36b113acf33567%3A0xe29197ef56402e4c!2sBentiring%2C%20Muara%20Bangka%20Hulu%2C%20Bengkulu%20City%2C%20Bengkulu!5e0!3m2!1sen!2sid!4v1627198867201!5m2!1sen!2sid" width="100%" height="500" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
